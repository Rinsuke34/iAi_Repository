...
static const int	PLAYER_STATE_DRAW_SWORD_CHARGE				= 4;	// 溜め居合(溜め)
static const int	PLAYER_STATE_DRAW_SWORD_CHARGE_ATTACKING	= 12;	// 溜め居合(攻撃中)
static const int	PLAYER_STATE_DRAW_SWORD_CHARGE_FINISH		= 13;	// 溜め居合(終了)
