...
DataList_PlayerStatus::DataList_PlayerStatus() : DataListBase("DataList_PlayerStatus")
{
	...
	this->iPlayerMeleeStrongAirMaxCount		= 0;	// プレイヤーの空中での近距離攻撃(強)回数(※敵を攻撃していない場合の最大数)		/* 2025.03.19 菊池雅道 初期化処理追加 */
	...
	this->fPlayerMelleStrongMoveScale		= 0;	// プレイヤーの近距離攻撃(強)の移動距離のスケールのスケール						/* 2025.03.19 菊池雅道 初期化処理追加 */
	this->fPlayerMeleeStrongMoveSpeed		= 0;	// プレイヤーの近距離攻撃(強)の移動速度											/* 2025.03.19 菊池雅道 初期化処理追加 */
	this->iPlayerMeleeStrongContinusMaxFrame = 0;	// プレイヤーの近距離攻撃(強)で連続攻撃できる最大フレーム数						/* 2025.03.19 菊池雅道 初期化処理追加 */
