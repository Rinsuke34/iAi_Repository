...
static const int	CAMERA_POSITION_LEAP_COUNT_MAX_MELEE		= 15 * 1;		// カメラ座標の線形保管用カウントの最大値(近距離攻撃(強))		/* 2025.03.06 菊池雅道 定数追加 */
static const int	CAMERA_POSITION_LEAP_COUNT_MAX_PROJECTILE	= 10 * 1;		// カメラ座標の線形保管用カウントの最大値(遠距離攻撃)			/* 2025.03.06 菊池雅道 定数追加 */
