...
/* エネミー自爆型 */
static const int	ENEMY_NORMAL_DURATION_COUNT = 1300;					//ノーマル弾の持続カウント
...
static const int	ENEMY_BEAM_CHARGE_COUNT = 120;						//ビームチャージカウント
static const int	ENEMY_BEAM_DURATION_COUNT = 120;					//ビームの持続カウント
