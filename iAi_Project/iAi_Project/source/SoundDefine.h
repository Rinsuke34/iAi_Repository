...
static  const int   VOICE_DOCTOR_PRAISE_S                   = 17;   // 賞賛(博士/Sランク)
static  const int   VOICE_DOCTOR_RESULT_S                   = 18;   // 結果S(博士)
static  const int   VOICE_DOCTOR_RESULT_A                   = 19;   // 結果A(博士)
static  const int   VOICE_DOCTOR_RESULT_BC                  = 20;   // 結果BC(博士)
static  const int   VOICE_DOCTOR_RESULT_D                   = 21;   // 結果D(博士)
static  const int   VOICE_DOCTOR_CONVERSATION_CONSENT       = 22;   // 会話(博士/ああ)
static  const int   VOICE_DOCTOR_CONVERSATION_BYTHEWAY      = 23;   // 会話(博士/ところで)
static  const int   VOICE_DOCTOR_CONVERSATION_THAT_1        = 24;   // 会話(博士/あれは1)
static  const int   VOICE_DOCTOR_CONVERSATION_THAT_2        = 25;   // 会話(博士/あれは2)
...
const VOICE_INFO stVoice_Info[VOICE_MAX] =
{
    ...
    { VOICE_TYPE_DOCTOR,    VOICE_DOCTOR_PRAISE_S,                  "CV_S_Result_S4"    },      // 賞賛(博士/Sランク)
