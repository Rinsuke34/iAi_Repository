...
class DataList_PlayerStatus : public DataListBase
{
	public:
		...
		int		iGetPlayerJumpCount()				 { return this->iPlayerJumpCount; }					//プレイヤーの現在のジャンプ回数を取得
		...
		/* 2025.01.22 菊池雅道 攻撃関連の変数追加 開始 */
		VECTOR	vecGetPlayerChargeAttakTargetPoint() { return this->vecPlayerChargeAttakTargetPoint; }	//プレイヤー溜め攻撃の方向を取得
		/* 2025.01.22 菊池雅道 移動関連の関数追加 終了 */
		...
		void	SetPlayerChargeAttakTargetPoint(VECTOR vecPlayerChargeAttakTargetPoint)		{ this->vecPlayerChargeAttakTargetPoint = vecPlayerChargeAttakTargetPoint; }	////プレイヤー溜め攻撃の方向を設定
		/* 2025.01.22菊池雅道 移動関連の関数追加 終了 */
	...
	private:
		...
		/* 2025.01.22 菊池雅道 攻撃関連の変数追加開始 */
		VECTOR  vecPlayerChargeAttakTargetPoint;	//プレイヤー溜め攻撃の目的地
