...
void SceneUi_Debug_StatusSetup::Draw()
{
	...
	DrawFormatString(1400, 350 + 16 * 1, GetColor(255, 255, 255), "%f", this->PlayerStatusList->fGetPlayerJumpSpeed());
	DrawFormatString(870, 350 + 16 * 2, GetColor(255, 255, 255), "落下加速度");
	DrawFormatString(1400, 350 + 16 * 2, GetColor(255, 255, 255), "%f", this->PlayerStatusList->fGetPlayerFallAcceleration());
