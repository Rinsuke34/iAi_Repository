...
static const float	OPTION_SOUND_VOLUME_MAX			=	16.f;		// サウンドの音量の最大値
...
const std::string OPTION_NAME_OPERATION_KEYBOARD				= "Operation_Keyboard";						// 操作説明キーボード表示
...
const std::string OPTION_NAME_OPERATION_KEYBOARD_JP					= "操作説明キーボード表示";						// 操作説明キーボード表示
