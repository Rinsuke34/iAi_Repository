...
{ {
	// 名称(日本語),	画像名
	{ "なし",			"Test_Edit/Frame/EditFrame_None" },
	{ "銅",				"Test_Edit/Frame/EditFrame_Cupper" },
	{ "銀",				"Test_Edit/Frame/EditFrame_Silver" },
	{ "金",				"Test_Edit/Frame/EditFrame_Gold" }
} };

static const std::array<EDIT_NAME, EDIT_EFFECT_MAX> EDIT_EFFECT_NAME =
{ {
	// 名称(日本語),				画像名
	{ "なし",						"Test_Edit/Effect/NoImage" },
	{ "移動速度アップ",				"Test_Edit/Effect/Edit_SpeedUp" },
	{ "ブラッド取得量アップ",		"Test_Edit/Effect/Edit_BloodUp" },
	{ "コンボ継続時間アップ",		"Test_Edit/Effect/Edit_ComboUp" },
	{ "近接攻撃ため時間減少",		"Test_Edit/Effect/Edit_ChargeSpeedUp" },
	{ "ジャンプ回数アップ",			"Test_Edit/Effect/Edit_JumpAdd" },
	{ "空中居合攻撃回数アップ",		"Test_Edit/Effect/Edit_KunaiKeep" },
	{ "クナイ取得量アップ",			"Test_Edit/Effect/Edit_KunaiAdd" },
	{ "バリア回数アップ",			"Test_Edit/Effect/Edit_BarrierAdd" },
	{ "滑空アクション追加",			"Test_Edit/Effect/NoImage" },
	{ "カウンターアクション追加",	"Test_Edit/Effect/NoImage" },
	{ "ダッシュ、回避制限",			"Test_Edit/Effect/NoImage" },
	{ "HP1制限",					"Test_Edit/Effect/NoImage" },
	{ "居合キャンセル制限",			"Test_Edit/Effect/NoImage" }
} };
