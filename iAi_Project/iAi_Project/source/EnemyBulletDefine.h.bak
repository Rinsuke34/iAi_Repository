...
static const int	ENEMY_MISSILE_BULLET_GUIDANCE_COUNT = 340;			//ミサイル弾誘導カウント
static const int	ENEMY_BEAM_BULLET_COUNT = 130;					//ビーム発射カウント
static const int	ENEMY_BEAM_CHARGE_COUNT = 175;						//ビームチャージカウント
static const int	ENEMY_BEAM_DURATION_COUNT = 435;					//ビームの持続カウント